import React, { Children, Context, createContext, useEffect } from "react";
...
export const createChangeNotifierContext = <S, T>(
  changeNotifier: ChangeNotifier<S, T>
) => createContext<ChangeNotifier<S, T> | null>(changeNotifier);

export class ChangeNotifierProviderV1<S, A> extends React.Component<
  IProps<S, A>,
  IComponentState<S, A>
> {
  constructor(props) {
